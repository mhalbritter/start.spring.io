...
class StartInitializrMetadataUpdateStrategyTests {
	...
	void eolVersionsAreRemoved() {
		...
		assertBootVersion(updatedBootVersions.get(0), "3.4.0 (SNAPSHOT)", false);
		assertBootVersion(updatedBootVersions.get(1), "3.4.0 (RC1)", false);
		assertBootVersion(updatedBootVersions.get(2), "3.3.6 (SNAPSHOT)", false);
		assertBootVersion(updatedBootVersions.get(3), "3.3.5", true);
	}
